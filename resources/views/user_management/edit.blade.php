    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('user-management.update', $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                id="name" value="{{ old('name', $user->name) }}" placeholder="Enter name" required>
                            @error('name')
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control @error('contact_number') is-invalid @enderror"
                                            ...
                                            value="{{ old('contact_number', $user->contact_number) }}" aria-describedby="basic-addon1">
                                    </div>
